...
<div class="flex flex-col group">
	...
	>
		<img
			src="/keyfactor_logo.svg"
			alt="Keyfactor logo"
			class="bg-[#5F61FF] rounded-full p-1 my-auto mr-1"
			width="48px"
			height="48px"
		/>
	...
	>
		<img
			...
			alt="Ericsson logo"
			class="bg-black rounded-full p-1 my-auto mr-1"
			width="48px"
			height="48px"
		/>
		<div class="flex flex-col flex-grow py-5 h-full">
			<span class="text-gray-800 font-semibold flex-grow">Summer Intern and Innovation Intern</span>
			<span class="text-gray-600 font-semibold pr-auto">Ericsson</span>
		</div>
		<span class="text-gray-600 py-5 pr-8 h-full">2021 - 2022</span>
	</a>
	<a
		class="flex gap-1 justify-between group-hover:opacity-50 hover:!opacity-100"
		href="https://kth.se/"
	...
	>
		<img
			src="/kth_logo.svg"
			alt="KTH logo"
			class="bg-[#1751a6] rounded-full p-1 my-auto mr-1"
			width="48px"
			height="48px"
		/>
		<div class="flex flex-col flex-grow py-5 h-full">
			<span class="text-gray-800 font-semibold flex-grow">Teaching assistant</span>
			<span class="text-gray-600 font-semibold pr-auto">KTH Royal Institute of Technology</span>
		</div>
		<span class="text-gray-600 py-5 pr-8 h-full">2019</span>
	</a>
</div>
