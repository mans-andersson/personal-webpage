...
<div class="flex py-5 items-center justify-start">
  <img
    src="/pfp.jpeg"
    alt="Me standing in front of a tree"
    class="rounded-full h-32 mr-5"
  />
...
<p class="text-gray-800 pt-3 text-sm">
  I am a software engineer based in Stockholm, Sweden. I have a passion for
  technology, and I like building cool things. Other things I enjoy are
  climbing, skiing, and fishing.
</p>
